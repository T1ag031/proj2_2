...
public class menufuncionariocontroller {
    ...
    void gerirencomendas(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("gerirEncomendasFunc.fxml"));
    ...
    void gerirpecas(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("gerirPecasFunc.fxml"));
        stage = (Stage)((Node)event.getSource()).getScene().getWindow();
        scene = new Scene(root);
        stage.setScene(scene);
        stage.show();
    ...
    void gerirtecido(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("gerirTecidoFunc.fxml"));
        stage = (Stage)((Node)event.getSource()).getScene().getWindow();
        scene = new Scene(root);
        stage.setScene(scene);
        stage.show();
